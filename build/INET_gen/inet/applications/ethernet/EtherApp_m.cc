//
// Generated file, do not edit! Created by nedtool 5.6 from /home/vagrant/artery/extern/inet/src/inet/applications/ethernet/EtherApp.msg.
//
...
EtherAppReq::EtherAppReq(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->requestId = 0;
...
const char *EtherAppReqDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
EtherAppResp::EtherAppResp(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->requestId = 0;
    this->numFrames = 0;
}
...
const char *EtherAppRespDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
