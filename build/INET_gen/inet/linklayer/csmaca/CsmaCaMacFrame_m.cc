//
// Generated file, do not edit! Created by nedtool 5.6 from /home/vagrant/artery/extern/inet/src/inet/linklayer/csmaca/CsmaCaMacFrame.msg.
//
...
CsmaCaMacFrame::CsmaCaMacFrame(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
}
...
{
    if (!propertynames) {
        static const char *names[] = { "implements",  nullptr };
...
{
    if (!strcmp(propertyname,"implements")) return "IMACFrame";
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *CsmaCaMacFrameDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
CsmaCaMacAckFrame::CsmaCaMacAckFrame(const char *name, short kind) : ::inet::CsmaCaMacFrame(name,kind)
{
}
...
const char *CsmaCaMacAckFrameDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
CsmaCaMacDataFrame::CsmaCaMacDataFrame(const char *name, short kind) : ::inet::CsmaCaMacFrame(name,kind)
{
    this->priority = 0;
}
...
const char *CsmaCaMacDataFrameDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
