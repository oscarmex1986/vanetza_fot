//
// Generated file, do not edit! Created by nedtool 5.6 from /home/vagrant/artery/extern/inet/src/inet/transportlayer/rtp/RTPSenderStatusMessage.msg.
//
...
const char *RTPSenderStatusMessageDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
