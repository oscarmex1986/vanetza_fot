...
/**
 * Class generated from <tt>/home/vagrant/artery/extern/inet/src/inet/transportlayer/rtp/RTCPPacket2.msg:29</tt> by nedtool.
 * <pre>
 ...
 *   public:
 *     RTCPReceiverReportPacket(const char *name=nullptr, short kind=0) : RTCPReceiverReportPacket_Base(name,kind) {}
...
class RTCPReceiverReportPacket_Base : public ::inet::rtp::RTCPPacket
{
  ...
  public:
    ...
    virtual RTCPReceiverReportPacket_Base *dup() const override {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class RTCPReceiverReportPacket");}
...
/**
 * Class generated from <tt>/home/vagrant/artery/extern/inet/src/inet/transportlayer/rtp/RTCPPacket2.msg:37</tt> by nedtool.
 * <pre>
 ...
 *   public:
 *     RTCPSDESPacket(const char *name=nullptr, short kind=0) : RTCPSDESPacket_Base(name,kind) {}
...
class RTCPSDESPacket_Base : public ::inet::rtp::RTCPPacket
{
  ...
  public:
    ...
    virtual RTCPSDESPacket_Base *dup() const override {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class RTCPSDESPacket");}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const override;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b) override;
...
/**
 * Class generated from <tt>/home/vagrant/artery/extern/inet/src/inet/transportlayer/rtp/RTCPPacket2.msg:44</tt> by nedtool.
 * <pre>
 ...
 *   public:
 *     RTCPByePacket(const char *name=nullptr, short kind=0) : RTCPByePacket_Base(name,kind) {}
...
class RTCPByePacket_Base : public ::inet::rtp::RTCPPacket
{
  ...
  public:
    ...
    virtual RTCPByePacket_Base *dup() const override {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class RTCPByePacket");}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const override;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b) override;
