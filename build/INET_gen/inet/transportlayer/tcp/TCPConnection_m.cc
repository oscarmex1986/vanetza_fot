//
// Generated file, do not edit! Created by nedtool 5.6 from /home/vagrant/artery/extern/inet/src/inet/transportlayer/tcp/TCPConnection.msg.
//
...
TCPConnectionDescriptor::TCPConnectionDescriptor() : omnetpp::cClassDescriptor("inet::tcp::TCPConnection", "omnetpp::cObject")
{
...
int TCPConnectionDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='l' && strcmp(fieldName, "localAddress")==0) return base+0;
    if (fieldName[0]=='l' && strcmp(fieldName, "localPort")==0) return base+1;
    if (fieldName[0]=='r' && strcmp(fieldName, "remoteAddress")==0) return base+2;
...
std::string TCPConnectionDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    TCPConnection *pp = (TCPConnection *)object; (void)pp;
    switch (field) {
        case 0: {std::stringstream out; out << pp->getLocalAddress(); return out.str();}
        case 1: return long2string(pp->getLocalPort());
        case 2: {std::stringstream out; out << pp->getRemoteAddress(); return out.str();}
