//
// Generated file, do not edit! Created by nedtool 5.6 from /home/vagrant/artery/extern/inet/src/inet/networklayer/flood/FloodDatagram.msg.
//
...
FloodDatagram_Base::FloodDatagram_Base(const char *name, short kind) : ::inet::NetworkDatagramBase(name,kind)
{
    this->ttl = 1;
    this->seqNum = 0;
...
const char *FloodDatagramDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
