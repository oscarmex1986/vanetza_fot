//
// Generated file, do not edit! Created by nedtool 5.6 from /home/vagrant/artery/extern/inet/src/inet/networklayer/rsvp_te/RSVPPacket.msg.
//
...
RSVPMessage::RSVPMessage(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->rsvpKind = 0;
}
...
const char *RSVPMessageDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
RSVPPacket_Base::RSVPPacket_Base(const char *name, short kind) : ::inet::RSVPMessage(name,kind)
{
...
const char *RSVPPacketDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
