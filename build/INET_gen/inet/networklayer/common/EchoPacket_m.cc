//
// Generated file, do not edit! Created by nedtool 5.6 from /home/vagrant/artery/extern/inet/src/inet/networklayer/common/EchoPacket.msg.
//
...
EchoPacket::EchoPacket(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->type = 0;
}
...
const char *EchoPacketDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
