//
// Generated file, do not edit! Created by nedtool 5.6 from /home/vagrant/artery/extern/inet/src/inet/networklayer/common/IPProtocolId.msg.
//
...
EXECUTE_ON_STARTUP(
    ...
    e->insert(IP_PROT_ESP, "IP_PROT_ESP");
    e->insert(IP_PROT_AH, "IP_PROT_AH");
...
const char *IPRegisterProtocolCommandDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
