//
// Generated file, do not edit! Created by nedtool 5.6 from /home/vagrant/artery/extern/inet/src/inet/networklayer/ipv4/IPv4Route.msg.
//
...
IPv4RouteDescriptor::IPv4RouteDescriptor() : omnetpp::cClassDescriptor("inet::IPv4Route", "omnetpp::cNamedObject")
{
...
int IPv4RouteDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='g' && strcmp(fieldName, "gateway")==0) return base+2;
    if (fieldName[0]=='m' && strcmp(fieldName, "metric")==0) return base+3;
    if (fieldName[0]=='p' && strcmp(fieldName, "prefixLength")==0) return base+4;
    if (fieldName[0]=='i' && strcmp(fieldName, "interfaceName")==0) return base+5;
...
int IPv4RouteDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    IPv4Route *pp = (IPv4Route *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *IPv4RouteDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string IPv4RouteDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 1: {std::stringstream out; out << pp->getNetmask(); return out.str();}
        case 2: {std::stringstream out; out << pp->getGateway(); return out.str();}
        case 3: return long2string(pp->getMetric());
        case 4: return long2string(pp->getPrefixLength());
        case 5: return oppstring2string(pp->getInterfaceName());
        default: return "";
    }
}

bool IPv4RouteDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *IPv4RouteDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
