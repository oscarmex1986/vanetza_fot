//
// Generated file, do not edit! Created by nedtool 5.6 from /home/vagrant/artery/src/artery/utility/AsioData.msg.
//
...
bool AsioDataDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
