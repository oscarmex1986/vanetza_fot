...
ManagementInformationBase::ManagementInformationBase() :
    ...
    itsGnCbfMinTime(1 * milliseconds),//OAM default 1 ms
    itsGnCbfMaxTime(100 * milliseconds),//OAM default 100 ms
    itsGnDefaultMaxCommunicationRange(1000 * meters),
    itsGnBroadcastCBFDefSectorAngle(30 * degrees),
    itsGnUcForwardingPacketBufferSize(256),//OAM default 256
    itsGnBcForwardingPacketBufferSize(1024),//OAM default 1024
    itsGnCbfPacketBufferSize(256),//OAM default 256
    itsGnDefaultTrafficClass(false, false, 0),
    vanetzaDefaultSeed(0xc0114c2c),
    vanetzaCbfMaxCounter(1),
    vanetzaDeferInitialBeacon(false),
    vanetzaDisableBeaconing(false),//OAM default false
    vanetzaMultiHopDuplicateAddressDetection(false),//OAM default false
    vanetzaFadingCbfCounter(false),//OAM default false
